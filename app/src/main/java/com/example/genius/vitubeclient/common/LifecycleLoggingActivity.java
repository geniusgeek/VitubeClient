...
public abstract class LifecycleLoggingActivity extends AppCompatActivity {
    ...
    /**
     * Serves as the template methods of the template Method pattern to return the menu view for the activity
     *
     * @return
     */
    ...
    /**
     * Serves as the template methods of the template Method pattern to return the content view for the activity
     *
     * @return
     */
