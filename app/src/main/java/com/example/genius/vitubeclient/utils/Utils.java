...
public class Utils {
    ...
    /**
     * This utility method converts enum constants in an EnumClass to the String
     *
     * @param enumClass
     * @return
     */
     ...
     * This utility method converts enum constants in an EnumClass to the String
     *
     * @param values for the enum
     * @return
     */
    public static <T extends Enum<T>> String[] enumNameToString(T[] values) {
        int i = 0;
