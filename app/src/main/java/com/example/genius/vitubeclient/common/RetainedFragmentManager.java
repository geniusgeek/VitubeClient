...
public class RetainedFragmentManager {
    ...
    public <T> T get(Object key) {
         return (T) mRetainedFragment.get(key.getClass().getName());
    }

    public boolean containsObject(Object object){
       return mRetainedFragment.containsObject(object);
    }

    public boolean containsKey(String key){
        return mRetainedFragment.containsKey(key);
    }
    ...
    public static class RetainedFragment extends Fragment {
        ...
        public boolean containsObject(Object object){
            return mData.containsKey(object.getClass().getName());
        }
